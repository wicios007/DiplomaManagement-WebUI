...
@Component({
  selector: 'app-proposed-theses-add',
  templateUrl: './proposed-theses-add.component.html',
  styleUrls: ['./proposed-theses-add.component.css']
})
export class ProposedThesesAddComponent implements OnInit {
